...
<html>
<head>
<title>Skill Hub|| Home Page</title>
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
          <!--<h3>Digital Collaboration System</h3>   --><br> <br> <br> <br> <br> <br> <br>   
           <p>Registered Users can login here</p>             
          <div class="readmore">
          <a href="user/login.php">User Login<i class="glyphicon glyphicon-menu-right"> </i></a>
          </div>
         </li>
