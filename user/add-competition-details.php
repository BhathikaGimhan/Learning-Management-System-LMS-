...
<html lang="en">
  <head>
    ...
    <title>Skill Hub|| Add Competition Details</title>
    <!-- plugins:css -->
            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                 ...
                 <li class="breadcrumb-item active" aria-current="page"> Add Competition Details</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Add Competition Details</h4>
                   
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      
                      <div class="form-group">
                        <label for="exampleInputName1">Competition Name</label>
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Venue</label>
                        <input type="text" name="stuname" value="" class="form-control" required='true'>
...
<option value="<?php echo htmlentities($row1->ID);?>"><?php echo htmlentities($row1->ClassName);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
                      ...
                      <div class="form-group">
                        <label for="exampleInputName1"> Alternative Contact Number</label>
