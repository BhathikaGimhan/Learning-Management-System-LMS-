...
?>
                          <span class="report-title">Total Batch</span>
                          <h4><?php echo htmlentities($totclass);?></h4>
                          <a href="manage-class.php"><span class="report-count"> View Batches</span></a>
                        </div>
...
?>
                          <span class="report-title">Total Public Batch Notice</span>
